...
(function () {
  ...
  const ICONS = {
    accessibility:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm3.5 5h-7C7.67 7 7 7.67 7 8.5S7.67 10 8.5 10H10v4.5l-2.5 5a1 1 0 0 0 1.79.89L12 15l2.71 5.39a1 1 0 0 0 1.79-.89l-2.5-5V10h1.5c.83 0 1.5-.67 1.5-1.5S16.33 7 15.5 7Z"/></svg>',
    fontSize:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M2 4v3h5v12h3V7h5V4H2Zm19 5h-9v3h3v7h3v-7h3V9Z"/></svg>',
    lineHeight:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9 7h11v2H9V7Zm0 4h11v2H9v-2Zm0 4h11v2H9v-2ZM4 7l3-3v2h2v2H7v2L4 7Zm3 10v2H5v2H7v2l3-3-3-3Z"/></svg>',
    alignLeft:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3h18v2H3V3Zm0 4h12v2H3V7Zm0 4h18v2H3v-2Zm0 4h12v2H3v-2Zm0 4h18v2H3v-2Z"/></svg>',
    readableFont:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M9.93 13.5h4.14L12 7.98l-2.07 5.52ZM20 2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2Zm-4.05 16.5-1.14-3H9.17l-1.12 3H5.96l5.11-13h1.86l5.11 13h-2.09Z"/></svg>',
    contrast:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2Zm0 18V4c4.41 0 8 3.59 8 8s-3.59 8-8 8Z"/></svg>',
    grayscale:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10 10-4.49 10-10S17.51 2 12 2Zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8Zm3-8c0 1.66-1.34 3-3 3s-3-1.34-3-3 1.34-3 3-3 3 1.34 3 3Z"/></svg>',
    hideImages:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M21 5v6.59l-3-3.01-4 4.01-4-4-4 4-3-3.01V5c0-1.1.9-2 2-2h14c1.1 0 2 .9 2 2Zm-3 6.42 3 3.01V19c0 1.1-.9 2-2 2H5c-1.1 0-2-.9-2-2v-6.58l3 2.99 4-4 4 4 4-4.01Z"/></svg>',
    pauseAnimations:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2Zm-1 14H9V8h2v8Zm4 0h-2V8h2v8Z"/></svg>',
    highlightLinks:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3.9 12c0-1.71 1.39-3.1 3.1-3.1h4V7H7c-2.76 0-5 2.24-5 5s2.24 5 5 5h4v-1.9H7c-1.71 0-3.1-1.39-3.1-3.1ZM8 13h8v-2H8v2Zm9-6h-4v1.9h4c1.71 0 3.1 1.39 3.1 3.1s-1.39 3.1-3.1 3.1h-4V17h4c2.76 0 5-2.24 5-5s-2.24-5-5-5Z"/></svg>',
    readingMask:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3h18v2H3V3Zm0 16h18v2H3v-2Zm0-4h18v2H3v-2Zm0-4h18v2H3v-2Zm0-4h18v2H3V7Z"/></svg>',
    focusOutline:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3h6v2H5v4H3V3Zm0 12h2v4h4v2H3v-6Zm18 0v6h-6v-2h4v-4h2Zm0-12v6h-2V5h-4V3h6Z"/></svg>',
    showStructure:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M3 3h8v8H3V3Zm10 0h8v8h-8V3ZM3 13h8v8H3v-8Zm10 0h8v8h-8v-8Z"/></svg>',
    reset:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M17.65 6.35A7.96 7.96 0 0 0 12 4c-4.42 0-7.99 3.58-7.99 8s3.57 8 7.99 8c3.73 0 6.84-2.55 7.73-6h-2.08A5.99 5.99 0 0 1 12 18c-3.31 0-6-2.69-6-6s2.69-6 6-6c1.66 0 3.14.69 4.22 1.78L13 11h7V4l-2.35 2.35Z"/></svg>',
    close:
      '<svg class="a11y-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41Z"/></svg>',
  };
  ...
  function createReadingMask() {
    if (maskTopEl) return;
    maskTopEl = createEl("div", {
      className: "a11y-reading-mask-overlay a11y-reading-mask-top",
    });
    maskBottomEl = createEl("div", {
      className: "a11y-reading-mask-overlay a11y-reading-mask-bottom",
    });
  ...
  function buildWidget() {
    ...
    const headerActions = createEl(
      "div",
      { className: "a11y-header-actions" },
      [resetBtn, closeBtn],
    );
    const headerTitle = createEl("h2", {
      innerHTML: ICONS.accessibility + " Accessibilit\u00e9",
    });
    const header = createEl("div", { className: "a11y-panel-header" }, [
      headerTitle,
      headerActions,
    ]);
    ...
    if (f.type === "step") {
      ...
      f.steps.forEach(() => {
        dotsContainer.appendChild(
          createEl("span", { className: "a11y-step-dot" }),
        );
      });

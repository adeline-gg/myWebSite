...
```css
--primary: #357c7a /* Teal principal */ --primary-light: #5aa8a6
  /* Teal clair */ --primary-dark: #2a6562 /* Teal foncé */ --secondary: #9fd3c0
  /* Vert doux */ --accent: #e8b59a /* Pêche/beige */ --text-dark: #2d3748
  /* Texte principal */ --text-light: #718096 /* Texte secondaire */ --bg-light:
  #faf7f2 /* Fond clair */;
```
